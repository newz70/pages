...
class ProductBox {
  ...
  function ShowProductLeft($list, $text){
?>
<div>
...
?>
      ...
      <div class="articledesc">
        <div style="float:left; padding-right:420px">
<?php
...
<div style="float: left; width: 300px"><img src="http://www.omoza.ru/assets/images/dacha.jpg" width="300" height="180" border="0" alt="" /></div>
 <div style="margin-left: 310px; text-align: justify">
...
$list = array(
  ...
  array("liplus"=>"Инновационная гибоидная схема обеспечивает защиту в широком диапазоне (100 - 280В) входного напряжения"),
...
$prod->ShowProductLeft($list, $text);
?>
