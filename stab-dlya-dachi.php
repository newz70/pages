...
$list = array(
  array("liplus"=>"Качественный стабилизатор отечественного производства"),
  array("liplus"=>"Инновационная гибридная схема обеспечивает защиту в широком диапазоне (100 - 280В) входного напряжения"),
  array("liplus"=>"Мощность 10 кВа позволяет обеспечить все электроприборы  качественным электропитанием"),
  array("liplus"=>"Микропроцессорный контроль"),
  array("liplus"=>"Гарантия 1 год"),
  array("liplus"=>"Бесплатная доставка"),
);
$text = "Качественный гибридный стабилизатор напряжения, предназначенный для использования на даче. Обеспечивает защиту электроприборов в широком диапазоне напряжений. Номинальная мощность позволяет использовать его для обеспечения стабильным напряжением на большинстве дач. Если мощность данного стабилизатра для Вас избыточна, предлагаем <a href=\"/product/voltron-rsn-8000h.html\">Voltron РСН-8000h</a> <b>(8 кВА, </b>цена - <b>10010.00 руб)</b>.";
