...
$desc = "Инвертор со встроенным стабилизатором напряжения, применяемый для построения систем бесперебойного питания газовых котлов <b>мощностью 0.3 кВА</b>";
$har = array(
...
$desc = "Инвертор со встроенным стабилизатором напряжения, применяемый для защиты и обеспечения бесперебойного питания газовых котлов <b>мощностью 0.5 кВА</b>";
$har = array(
  "Рабочий диапазон температур" => "-20..+40 °C",
...
$desc = "Инвертор со встроенным электронным стабилизатором для защиты котлов и обеспечения их беспрерывной работы при отключениях электричества <b>мощностью 0.7 кВА</b>";
$har = array(
  "Рабочий диапазон температур" => "-20..+40 °C",
